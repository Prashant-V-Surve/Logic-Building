...
class StudyTracker
{
    ...
    public void DisplayLog()
    {
        ...
        System.out.println("----------------------------------------------------");
        System.out.println("---- Log report from Dream Study Tracker ------");
        System.out.println("----------------------------------------------------");
    ...
    public void ExportCSV()
    {
        ...
        String FileName = "DreamStudy.csv";
        ...
        catch(Exception eobj)
        {
            ...
            System.out.println("Report this issue to Dream Infosystems");
        }
    }
    ...
    public void SummaryByDate()
    {
        ...
        System.out.println("----------------------------------------------------");
        System.out.println("-- Summary By Date from Dream Study Tracker ---");
        System.out.println("----------------------------------------------------");
    ...
    public void SummaryBySubject()
    {
        ...
        System.out.println("----------------------------------------------------");
        System.out.println(" Summary By Subject from Dream Study Tracker ");
        System.out.println("----------------------------------------------------");
...
class program558    // StudyTrackerStarter
{
    public static void main(String A[])
    {
        ...
        System.out.println("----------------------------------------------------");
        System.out.println("--Welcome to Dream Study Tracker Application --");
        System.out.println("----------------------------------------------------");
        ...
        do
        {
            ...
            switch(iChoice)
            {
                ...
                case 6:     // Exit the application
                    System.out.println("----------------------------------------------------");
                    System.out.println("Thank you for using Dream Study Log application");
                    System.out.println("----------------------------------------------------");
                    break;
